...
import { FaFacebook, FaUserCircle, FaEye, FaFileInvoiceDollar } from "react-icons/fa";
...
const SideDrawer = () => {
  ...
  return (
    <>
      ...
      {/* Overlay (visible when SideDrawer is open) */}
      {show && (
        <div
      ...
      {/* SideDrawer */}
      <div
        className={`fixed top-0 ${show ? "left-0" : "left-[-100%]"} transition-all duration-100 w-full sm:w-[300px] bg-[#f6f4f0] h-full z-50 p-4 flex flex-col justify-between lg:left-0 border-r-[1px] border-r-stone-500`}
      >
        <div className="relative">
          <Link to={"/"}>
            <h4 className="text-2xl font-semibold mb-4">
              Bid<span className="text-[#D6482b]">Storm</span>
            </h4>
          </Link>
        ...
        <div>
          ...
          <p className="text-stone-500">&copy; BidStorm, LLC.</p>
